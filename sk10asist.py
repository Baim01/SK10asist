...
║✪╠➣ [SK Respon] Cek Respon Bot
║✪╠➣ [SpeedSK]    Cek Kecepatan Bot
║✪╠➣ [Up]                Fungsi Spam Chat
║✪╠➣ [Sepi]             Mention Semua User
║✪╠➣ [Buronan]      Cek List Akun Banned
║✪╠➣ [Gn namagroup] Ganti Nama Group
║✪╠➣ [Cancel]        Cancel User Masuk
...
║
║✪╔═════════════════ 
║✪║           ✴ ̶ᴀ̶̶ᴅ̶̶ᴍ̶̶ɪ̶̶ɴ̶ ̶ᴄ̶̶ᴏ̶̶ᴍ̶̶ᴍ̶̶ᴀ̶̶ɴ̶̶ᴅ̶✴
║✪╠═════════════════
║✪║
    ...
    try:
        ...
        #-------------Fungsi Jam on/off Start-------------------#            
         ...
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["SK join","SK Join","sk join","SK JOIN","Kuy"]:
              if msg.from_ in admin:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if matched_list == []:
                        ...
                        kc.sendText(msg.to,"Jangan masuk lagi􀨁􀆷SK smile􏿿")
                        return
            ...
            #----------------Command tambahan----------------------#
              ...
              if msg.from_ in admin:
               ...
               cl.sendText(msg.to, "☆「Group List」☆\n"+ h +"Total Group : " +str(len(gid)))
                ...
                if msg.toType == 2:
                      msg.contentType = 13
                      Creatorbot = "u03625388921e6baa1e0fc85003b8fdef"
                      try:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["SK Respon","respon","Respon Dong","respon dong"]:
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
            elif msg.text in ["SpeedSK","speedbot"]:
                start = time.time()
